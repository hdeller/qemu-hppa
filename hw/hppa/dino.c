 ...
 * 368bec88d1916f65050be305f88c10a46075a51c: -> track
 *      value of DINO_PCI_CONFIG_ADDR, incl. lowest 2 bits
 * track value of DINO_IO_ADDR_EN, DINO_IO_FBB_EN,
 *      DINO_TOC_ADDR and all PCI ARB registers
